...
var CropperRoot = (_a) => {
  ...
  return /* @__PURE__ */ jsx(CropperContext.Provider, { value: contextValue, children: /* @__PURE__ */ jsx("div", __spreadProps(__spreadValues(__spreadValues({ ref: containerRef }, getRootProps()), restProps), { children })) });
};
var CropperImage = (_a) => {
  ...
  return /* @__PURE__ */ jsx("div", { style: getImageWrapperStyle(), children: /* @__PURE__ */ jsx("img", __spreadValues(__spreadProps(__spreadValues({}, imageProps), { className }), restProps)) });
};
...
var CropperDescription = (_a) => {
  ...
  return /* @__PURE__ */ jsx("div", __spreadProps(__spreadValues({ id: descriptionId, className }, restProps), { children: children != null ? children : (
